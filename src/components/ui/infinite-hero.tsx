...
export default function InfiniteHero() {
	...
	useGSAP(
		() => {
			// Animation logic removed as content is no longer present
		},
		{ scope: rootRef },
	);
	...
	return (
		...
		<div className="absolute inset-0" ref={bgRef}>
			...
			<div className="absolute inset-0">
				<SparklesCore className="h-full w-full" background="transparent" />
			</div>
		</div>			<div className="pointer-events-none absolute inset-0 [background:radial-gradient(120%_80%_at_50%_50%,_transparent_40%,_black_100%)]" />
